...
#
# Testscript to test hashwarp multiple pools/hosts/syntaxes
# Put this script in the bin directory of hashwarp and start running
#
...
# export some vars as "./hashwarp" could be still a wrapper script
...
#miningpoolhub.com
POOLS="$POOLS stratum2+tcp://USERNAME%2eWORKERNAME:WORKERPWD@asia.xhash-hub.miningpoolhub.com:20535"
POOLS="$POOLS stratum2+tcp://USERNAME%2eWORKERNAME:WORKERPWD@europe.xhash-hub.miningpoolhub.com:20535"
POOLS="$POOLS stratum2+tcp://USERNAME%2eWORKERNAME:WORKERPWD@us-east.xhash-hub.miningpoolhub.com:20535"
#miningpoolhub.com-ssl - see issue 1629 - seems not working
#POOLS="$POOLS stratum2+ssl://USERNAME%2eWORKERNAME:WORKERPWD@asia.xhash-hub.miningpoolhub.com:20535"
#POOLS="$POOLS stratum2+ssl://USERNAME%2eWORKERNAME:WORKERPWD@europe.xhash-hub.miningpoolhub.com:20535"
#POOLS="$POOLS stratum2+ssl://USERNAME%2eWORKERNAME:WORKERPWD@us-east.xhash-hub.miningpoolhub.com:20535"
#nanopool.org
...
for pool in $POOLS; do
    ...
    echo "./hashwarp -v 1 --exit --report-hashrate -P $pool $@"
    echo "./hashwarp -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./hashwarp -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
